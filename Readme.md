...
Сохраняем предсказанные значения в файл.
...
# Будем рады видеть ваши исправления, если вы захотите нам помочь в развитие данного задания!

## Спасибо за просмотр и изучение нашей работы, мы рады, что участвовали в хакатоне и планируем дальше разбираться в данной тематике!
